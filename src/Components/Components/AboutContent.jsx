  ...
  return (
    <Container className="about-container">
      ...
      <p>
        ...
        experience, we have established ourselves as a reliable and innovative
      ...
      <p>
        ...
        performance, durability, and aesthetics of our customers' products. We
        are committed to using advanced technologies, eco-friendly processes,
      ...
      <ul>
        ...
        <li>
          Quality Assurance: Quality is at the heart of everything we do. Our
          stringent quality control measures guarantee that each item leaving
          our facility meets the highest industry standards.
        </li>
        <li>
          Custom Solutions: We understand that every project is unique. Our team
          works closely with clients to develop tailor-made solutions that align
          with their specific needs and vision.
        </li>
        <li>
          Environmental Responsibility: As a responsible corporate citizen, we
          prioritize environmentally friendly practices. Our processes comply
          with all relevant regulations, and we continuously seek ways to
