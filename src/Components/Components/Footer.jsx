      ...
      <Container>
        <Row>
          <Col md={6}>
            <h5>About Us</h5>
            <p>
              ElectroplatingLB, founded in 1998, is a leading electroplating and
              metal finishing company based in Lebanon. With over two decades of
              experience, we have established ourselves as a reliable and
          ...
          <Col md={6}>
            <h5>Contact Us</h5>
            <p>Email: ralphkamel.rk@gmail.com</p>
            <p>Phone: +961 03 106 565</p>
